...
impl MessageProducer for KafkaProducer {
    async fn send<T: Serialize + Send + Sync>(
        ...
        // Explicit &[u8] slices so K/P are [u8], not Vec<u8> or [u8; N].
        ...
        // Send and await the delivery report.
        // OwnedDeliveryResult = Result<(partition, offset), (KafkaError, OwnedMessage)>
        self.inner
