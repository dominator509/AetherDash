...
import type { FeedItem, Opportunity, EdgeDecomposition, FeedDisplayHints } from '../types/opportunity';
...
function makeFeedItem(id: string, overrides?: { opp?: Partial<Opportunity>; hints?: Partial<FeedDisplayHints> }): FeedItem {
  return {
...
describe('EdgeTable', () => {
  ...
  it('does NOT show "(not applicable)" for non-zero values', () => {
    ...
    expect(screen.queryByText('0.00 (not applicable)')).toBeNull();
  });
